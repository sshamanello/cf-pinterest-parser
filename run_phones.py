...
def cmd_devices():
    from phone_manager import get_connected_devices, get_device_account
...
def cmd_warmup(serial: str | None):
    from phone_manager import get_connected_devices
    from pinterest_warmup import warmup_device_sync
